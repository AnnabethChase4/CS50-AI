...
def transition_model(corpus, page, damping_factor):
    ...
    num_links = len(corpus[page]) if corpus[page] else num_pages

    # Probability of choosing a link from the page
    for link in corpus:
        model[link] = (1 - damping_factor) / num_pages
        ...
        for page in corpus:
            ...
            for other_page, links in corpus.items():
                if page in links:
                    ...
                    new_pagerank[page] += damping_factor * pagerank[other_page] / num_links
